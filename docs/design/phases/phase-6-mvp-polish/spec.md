...
> Make the app reliable and pleasant to use on a mobile phone.
...
- Basic error handling (invalid forms, missing data)
- Deployment to Hetzner Ubuntu 24.04 (gunicorn + nginx setup)
