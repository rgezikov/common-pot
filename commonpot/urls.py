...
urlpatterns = [
    ...
    path('pot/<uuid:token>/placeholder/<int:member_id>/rename/', views.rename_placeholder, name='rename_placeholder'),
    ...
    path('list/<uuid:token>/suggestions/', views.manage_suggestions, name='manage_suggestions'),
    path('list/<uuid:token>/suggestion/<int:suggestion_id>/edit/', views.edit_suggestion, name='edit_suggestion'),
    path('list/<uuid:token>/suggestion/<int:suggestion_id>/delete/', views.delete_suggestion, name='delete_suggestion'),
